...
export default function SettingsNumbering() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Numbering</h1>
        <p className="text-muted-foreground">Manage numbering data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Numbering Overview</CardTitle>
