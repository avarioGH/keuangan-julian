...
export default function CustomersDashboard() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">customers Dashboard</h1>
        <p className="text-muted-foreground">Manage customers dashboard data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>customers Dashboard Overview</CardTitle>
