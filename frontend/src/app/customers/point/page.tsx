...
export default function CustomersPoint() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Point</h1>
        <p className="text-muted-foreground">Manage point data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Point Overview</CardTitle>
