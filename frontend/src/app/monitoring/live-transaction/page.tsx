...
export default function MonitoringLiveTransaction() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Live Transaction</h1>
        <p className="text-muted-foreground">Manage live transaction data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Live Transaction Overview</CardTitle>
