...
export default function MonitoringLoginHistory() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Login History</h1>
        <p className="text-muted-foreground">Manage login history data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Login History Overview</CardTitle>
