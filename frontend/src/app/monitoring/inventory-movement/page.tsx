...
export default function MonitoringInventoryMovement() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Inventory Movement</h1>
        <p className="text-muted-foreground">Manage inventory movement data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Inventory Movement Overview</CardTitle>
