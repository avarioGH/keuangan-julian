...
export default function MonitoringCashMovement() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Cash Movement</h1>
        <p className="text-muted-foreground">Manage cash movement data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Cash Movement Overview</CardTitle>
