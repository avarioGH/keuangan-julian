...
export default function MonitoringLivePos() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Live Pos</h1>
        <p className="text-muted-foreground">Manage live pos data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Live Pos Overview</CardTitle>
