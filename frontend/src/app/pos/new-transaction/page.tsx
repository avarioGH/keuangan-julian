...
export default function PosNewTransaction() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">New Transaction</h1>
        <p className="text-muted-foreground">Manage new transaction data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>New Transaction Overview</CardTitle>
