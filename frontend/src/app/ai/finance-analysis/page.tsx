...
export default function AiFinanceAnalysis() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold tracking-tight">Finance Analysis</h1>
        <p className="text-muted-foreground">Manage finance analysis data here.</p>
      </div>

      <Card>
        <CardHeader>
          <CardTitle>Finance Analysis Overview</CardTitle>
